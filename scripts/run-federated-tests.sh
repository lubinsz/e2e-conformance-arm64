...
#		CI_VERSION="v1.13.0-alpha.0.722+d46d67159f8265"
#		CI_VERSION="v1.13.0-alpha.0.718+b49e0b7f3a1831"
#		CI_VERSION="v1.13.0-alpha.0.710+b863b230106eb5"
...
#		NUM=$(gsutil cat gs://${PROJECT}/logs/${JOB}/latest.txt)
		NUM=$(gsutil ls gs://${PROJECT}/logs/${JOB} | wc -l)
		echo "NUM is ${NUM}"
		NEWNUM=$((NUM))
...
#		${TMP_DIR}/kubectl cp conformance/${pod_name}:/var/log/kubernetes/e2e/junit_01.xml ${JOB_DIR}/artifacts/junit_01.xml
